...
architecture Behavioral of tlc2 is
    ...
    type   t_state2 is (STOP1, WEST_GO,  WEST_WAIT,
                       STOP2, SOUTH_GO, SOUTH_WAIT,AUTO1,AUTO2);
...
--        );
    ...
    --------------------------------------------------------------------
    p_output2_fsm : process(s_state2)
    begin
        case s_state2 is
        
            when AUTO1 =>
                south_o <= "010";   -- GREEN (RGB = 100)
    ...
    begin
        if rising_edge(clk) then
            if (reset = '0') then       -- Synchronous reset
                ...
                s_state2 <= AUTO1 ;      -- Set initial state
                s_cnt   <= c_ZERO; 
